...
// ════════════════════════════════════════════════
// ADMIN ROUTES — duhet të jenë PARA /:id
// ════════════════════════════════════════════════

// A1. GET ALL RETURN REQUESTS (Admin)
router.get("/admin/returns", protect, authorizeRoles("admin"), async (req, res) => {
  try {
...
// A2. RESOLVE RETURN (Admin — aprovo/refuzo)
router.patch("/admin/returns/:id/resolve", protect, authorizeRoles("admin"), async (req, res) => {
  try {
...
// 5. RETURN / DEFECT — përditësuar me return_requested
